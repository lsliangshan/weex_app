<template>
  <div class="home">
    ...
    <scroller class="home-scroller" offset-accuracy="10" @loadmore="loadMore" :style="{height: (state.platform == 'web' ? (state.device.height - 120) / state.device.dpr : (750 / state.device.width * state.device.height - 120)) + 'px'}">
